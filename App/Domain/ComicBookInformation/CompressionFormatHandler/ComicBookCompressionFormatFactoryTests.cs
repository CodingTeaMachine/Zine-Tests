...
/// </summary>
public class ComicBookCompressionFormatFactoryTests
{
	[Fact]
	public void CBZ_Files_Should_Return_ZIP_Format_Test()
	{
		...
		var comicBookFormat = ComicBookCompressionFormatFactory.GetFromFile(filePath);

		Assert.Equal(ComicBookCompressionFormat.Zip, comicBookFormat);
	}
	...
	public void CBR_Files_Should_Return_RAR_Format_Test()
	{
		...
		Assert.Equal(ComicBookCompressionFormat.Rar, comicBookFormat);
	}
}
